...
optional<connection> http_server::listen(string const& url) noexcept {
	return manager()->listen(this, url);
}

void http_server::event_handler(connection const& connection, event event, void* event_data) noexcept {
